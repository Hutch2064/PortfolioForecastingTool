...
def main():
    ...
    if run_pressed:
        try:
            ...
            st.markdown(
                f"<p style='color:white; font-size:27px; font-weight:bold; margin-top:20px;'>Forecasted Portfolio Value <span style='font-weight:300;'>${final[-1] * start_cap:,.2f}</span></p>",
